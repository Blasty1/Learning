	...
	<div id="header" class="container">
		...
		<div id="menu">
			<ul>
				...
				<li class="<?php echo e(Request::path() == 'careers' ? 'current_page_item' : ''); ?>"><a href="#" accesskey="4" title="">Careers</a></li>
...
</html><?php /**PATH /var/www/html/Learning/bryan/resources/views////layout.blade.php ENDPATH**/ ?>